<?php 
 ...
 //$sender_name = is_null($meta) ? 0 : count($meta['sender_firstname']);
 //$sender_name = is_null($meta) ? 0 : count($meta['sender_middlename']);
 //$sender_name = is_null($meta) ? 0 : count($meta['sender_lastname']);
...
<div class="card card-outline card-primary">
    <div class="card-header d-flex">
        <h5 class="card-title col-auto flex-grow-1">Detaille du Transaction</h5>
        <div class="col-auto">
